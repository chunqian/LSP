...
def start_window_config(window: sublime.Window, workspace_folders: List[WorkspaceFolder],
                        designated_folder: Optional[WorkspaceFolder], config: ClientConfig,
                        on_pre_initialize: Callable[[Session], None],
                        on_post_initialize: Callable[[Session, Optional[Dict[str, Any]]],
                                                     None], on_post_exit: Callable[[str], None],
