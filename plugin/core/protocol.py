...
class Location(object):
    ...
    def from_lsp(cls, lsp_location: dict) -> 'Location':
        return Location(uri_to_filename(lsp_location["uri"]), Range.from_lsp(lsp_location["range"]))
...
class DiagnosticRelatedInformation(object):
    ...
    def from_lsp(cls, lsp_related_information: dict) -> 'DiagnosticRelatedInformation':
        return DiagnosticRelatedInformation(Location.from_lsp(lsp_related_information["location"]),
