...
def get_scope_client_config(view: sublime.View,
...
def get_scope_client_configs(view: sublime.View,
                             configs: List[ClientConfig],
    ...
    return (config_score[0]
            for config_score in sorted(scope_configs, key=lambda config_score: config_score[1], reverse=True))
