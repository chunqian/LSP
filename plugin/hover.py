...
class LspHoverCommand(LspTextCommand):
    ...
    def request_symbol_hover(self, point: int) -> None:
        ...
        if session:
            ...
            if session.client:
                session.client.send_request(Request.hover(document_position),
    ...
    def show_hover(self, point: int) -> None:
        ...
        contents = mistune.html(self.hover_content())
        if contents == "":
            return
    ...
    def on_hover_navigate(self, href: str, point: int) -> None:
        ...
        if href == 'references':
            ...
            print(html.parser.HTMLParser().unescape(href))
