...
class SingleDocumentTestCase(TextDocumentTestCase):
    ...
    def test_apply_formatting(self) -> 'Generator':
        original = ('<dom-module id="some-thing">\n'
                    '<style></style>\n'
                    '<template>\n'
                    '</template>\n'
                    '</dom-module>\n')
        ...
        expected = ('<dom-module id="some-thing">\n'
                    '<template>\n'
                    '    <style></style>\n'
                    '</template>\n'
                    '</dom-module>\n')
    ...
    def __run_formatting_test(self, original: 'Iterable[str]', expected: 'Iterable[str]',
                              file_changes: 'List[Tuple[Tuple[int, int], Tuple[int, int], str]]') -> 'Generator':
        assert self.view
