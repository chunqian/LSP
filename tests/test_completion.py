...
class QueryCompletionsTests(TextDocumentTestCase):
    ...
    def test_simple_label(self) -> 'Generator':
        ...
        if handler:
            ...
            self.assertEquals(self.view.substr(sublime.Region(0, self.view.size())), 'asdf')
    ...
    def test_space_added_in_label(self) -> 'Generator':
        ...
        if handler:
            ...
            self.view.run_command("commit_completion")
            yield from self.await_view_change(original_change_count + 1)
            self.assertEquals(self.view.substr(sublime.Region(0, self.view.size())), 'const')
    ...
    def test_dash_missing_from_label(self) -> 'Generator':
        ...
        if handler:
            ...
            self.view.run_command("commit_completion")
            yield from self.await_view_change(original_change_count + 2)
            self.assertEquals(self.view.substr(sublime.Region(0, self.view.size())), '-UniqueId')
    ...
    def test_edit_after_nonword(self) -> 'Generator':
        ...
        if handler:
            ...
            self.view.run_command("commit_completion", {})
            yield from self.await_view_change(original_change_count + 1)
            self.assertEquals(self.view.substr(sublime.Region(0, self.view.size())), 'List.apply()')
    ...
    def test_additional_edits(self) -> 'Generator':
        ...
        if handler:
            ...
            self.view.run_command("commit_completion", {})
            yield from self.await_view_change(original_change_count + 2)
            self.assertEquals(self.view.substr(sublime.Region(0, self.view.size())), 'import asdf;\nasdf')
